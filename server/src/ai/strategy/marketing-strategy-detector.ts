...
export function detectMarketingStrategy(prompt: string): MarketingStrategyDetection {
  ...
  if (
    ...
    return {
      goal: 'sales',
      funnelStage: 'BOFU',
      reasoning: 'Detected direct promotional offer/discount (Bottom of Funnel conversion).',
    };
  }
  ...
  if (
    ...
    return {
      goal: 'bookings',
      funnelStage: 'BOFU',
      reasoning: 'Detected reservation or booking intent (Bottom of Funnel booking).',
    };
  }
  ...
  if (
    ...
    return {
      ...
      funnelStage: 'MOFU',
      reasoning: 'Detected event or milestone celebration (Middle of Funnel engagement).',
    };
  }
  ...
  if (
    ...
    return {
      goal: 'product_launch',
      funnelStage: 'MOFU',
      reasoning: 'Detected new product drop or collection reveal (Middle of Funnel launch).',
    };
  }
  ...
  if (
    ...
    return {
      ...
      funnelStage: 'MOFU',
      reasoning: 'Detected lead capture / resource download offer (Middle of Funnel acquisition).',
    };
  }
  ...
  if (
    ...
    return {
      goal: 'newsletter',
      funnelStage: 'MOFU',
      reasoning: 'Detected newsletter subscription prompt (Middle of Funnel nurture).',
    };
  }
  ...
  if (
    ...
    return {
      ...
      funnelStage: 'TOFU',
      reasoning: 'Detected content reading or website traffic driver (Top of Funnel discovery).',
    };
  }
  ...
  if (
    ...
    return {
      ...
      funnelStage: 'TOFU',
      reasoning: 'Detected behind-the-scenes or brand culture storytelling (Top of Funnel connection).',
    };
  }
