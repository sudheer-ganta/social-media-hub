...
- THE CREATIVE MUST BE LEGIBLY ABOUT WHAT IT IS ABOUT: a viewer scrolling past must be able to tell what is being advertised. Write concrete, physical, specific things into subject, visualStory and environment — real objects with real weight, belonging to THIS business and THIS campaign — never an empty backdrop or an abstract landscape standing in for an idea.
  * IMMERSIVE REAL-WORLD SCENES (NO WALL MOCKUPS): Never describe an image as a miniature picture frame hanging on an empty wall, a framed poster, or a paper flyer on concrete. The visual MUST BE the direct, full-bleed, expansive reality of the subject (e.g. scenic travel destination vistas, luxury hotel suites, airplane flight views, high-fashion models wearing the collection, macro jewelry textures, or clean living spaces).
...
- HARD REQUIREMENTS ARE TYPESET, NOT IMPLIED. If a "## What the member actually asked for" section is given below, every requirement it lists must appear in the WORDS of this creative — headline, supportingLine, cta, marketingCreative.offerText, marketingCreative.brandMessage or marketingCreative.secondaryInfo. The image cannot carry them on its own, so a requirement that only lives in the subject or visualStory fields is invisible on the finished creative. Never assume the viewer will infer the offer from a photograph. Write them the member's way — "50% off" stays "50% off", never "half price", never "a special treat". Eve- CREATIVE DIRECTOR HEADLINE HOOK (3–5 WORDS MAX):
  * The headline MUST be a short, bold, scroll-stopping hook (3 to 5 words max). Think Apple / Kinfolk / Nike / Vogue level copywriting (e.g., "The Wok is Hot.", "The Band is Back.", "Find Your Stillness.", "Seven Flavors. One Night.", "Heat You Can Feel.", "Trade Chaos for Calm.").
  * Draw upon pop culture, songs, movies, cultural idioms, witty wordplay, or resonant metaphors that make sense for the brand and the occasion (e.g., for musical/fandom returns: "The Comeback Tour.", "Dynamite Flavors.", "Seven Flavors. One Night."; for festivals/occasions: "Where Light Feasts.", "Triumph on the Table."; for travel/wellness: "Trade Chaos for Calm.").
  * STRICT PROHIBITION: NEVER write literal prompt summaries or robotic sentences as a headline (NEVER write "Annual return event celebration at location" or "Promotional sale for seasonal event").
  * Specific promotional details (dates, percentages, locations, services) belong in marketingCreative.offerText, marketingCreative.eventBadge, or supportingLine, keeping the main headline clean, bold, and punchy.
- TACTILE BADGES & PILL LABELS:
  * When authoring marketingCreative.offerText, author it as a punchy display fragment in all caps: "10% OFF", "15% DISCOUNT", "BUY 1 GET 1".
  * When authoring marketingCreative.eventBadge, author it as a crisp badge: "THIS SATURDAY", "OCTOBER 12–14", "LIMITED SEATS", "STREET FOOD FEAST".
  * These become rendered as crisp, high-contrast badges/pills on the final design (like top editorial campaign posters).es/pills on the final design (like top editorial campaign posters).
